        ...
        >
          <div>
            <div className='flex items-center'>
              ...
              <span className='font-medium text-sm' style={{ color: 'rgb(36 36 36)' }}>{post.user.fullName}</span>
            </div>
          </div>
            ...
            <div className={styles.action}>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none">
                  <path d="M7 2C4.23858 2 2 4.23858 2 7V17C2 19.7614 4.23858 22 7 22H17C19.7614 22 22 19.7614 22 17V12C22 11.4477 21.5523 11 21 11C20.4477 11 20 11.4477 20 12V17C20 18.6569 18.6569 20 17 20H7C5.34315 20 4 18.6569 4 17V7C4 5.34315 5.34315 4 7 4H12C12.5523 4 13 3.55228 13 3C13 2.44772 12.5523 2 12 2H7Z" fill="#11823b"/>
                  <path d="M15.7929 3.79312C17.0119 2.57417 18.9882 2.57417 20.2071 3.79312C21.4261 5.01207 21.4261 6.98838 20.2071 8.20733L13.0988 15.3156C12.7144 15.7001 12.2326 15.9729 11.7051 16.1047L8.24256 16.9704C7.90178 17.0556 7.5413 16.9557 7.29291 16.7073C7.04453 16.459 6.94468 16.0985 7.02988 15.7577L7.89552 12.2951C8.0274 11.7676 8.30015 11.2859 8.68463 10.9014L15.7929 3.79312Z" fill="#11823b"/>
                </svg>
              </button>
            </div>
          )}
